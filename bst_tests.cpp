...
//     myTree.insert(10, 27);
//     myTree.insert(3, 42);
//     std::cout << "you added " << myTree.size() << " nodes" << std::endl;
//     std::vector<std::pair<int, int>> preTreeVec = myTree.preorder_contents();
//     for (int i = 0; i < preTreeVec.size(); i++)
//     {
//         std::cout << " key: " << preTreeVec[i].first << " value: " << preTreeVec[i].second << std::endl;
//     }
// 
//     std::vector<std::pair<int, int>> inTreeVec = myTree.inorder_contents();
//     for (int i = 0; i < inTreeVec.size(); i++)
//     {
//         std::cout << " key: " << inTreeVec[i].first << " value: " << inTreeVec[i].second << std::endl;
//     }
// 
//     if (myTree.contains(10))
//         std::cout << "you found it!" << std::endl;
// 
//     int &value = myTree.at(10);
//     std::cout << "the value at 10 is " << &value << std::endl;
//     return 0;
// }